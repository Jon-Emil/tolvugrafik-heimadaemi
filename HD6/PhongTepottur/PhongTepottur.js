...
//    gl.cullFace(gl.BACK);
    ...
    shadingModeLoc = gl.getUniformLocation(program, "useBlinn");
    gl.uniform1i(shadingModeLoc, useBlinn ? 1 : 0);
    ...
    document.getElementById("swap-shading").addEventListener("click", function() {
        useBlinn = !useBlinn;
        gl.uniform1i(shadingModeLoc, useBlinn ? 1 : 0);
        this.textContent = useBlinn ? "skipta í Phong" : "skipta í Blinn–Phong";
    });
